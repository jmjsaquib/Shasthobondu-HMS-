...
Source Database       : hms_production

Target Server Type    : MYSQL
Target Server Version : 50624
File Encoding         : 65001

Date: 2016-11-10 12:05:35
*/
...
INSERT INTO `admission` VALUES ('28', '13', '11/4/2016', '8', '7', null, '6', null, '11/4/2016', '12:00 AM', '31', '1', 'blank', 'confirmed', '100');
...
INSERT INTO `appoinment` VALUES ('17', '6', '2016-09-09', '4:30 PM', '1', '2', 'test', 'new', 'normal', '2');
INSERT INTO `appoinment` VALUES ('18', '5', '2016-09-09', '4:00 PM', '1', '2', 'trest', 'new', 'normal', '1');
...
INSERT INTO `appoinment` VALUES ('21', '6', '2016-09-09', '4:30 PM', '1', '2', 'test', 'new', 'normal', '6');
...
INSERT INTO `appoinment` VALUES ('41', '10', '2016-09-12', '5:30 PM', '2', '1', 'test', 'new', 'normal', '2');
INSERT INTO `appoinment` VALUES ('42', '13', '2016-11-04', '11 : 15', '7', '8', 'new', 'new', 'normal', '1');
...
-- Records of bank
-- ----------------------------
INSERT INTO `bank` VALUES ('1', 'DBBL', 'Dhanmondi-dhka', 'panthopath, dhaka', '199-101', null);
INSERT INTO `bank` VALUES ('2', 'City bank', 'Dhanmondi', 'Panthopath, dhaka', '199920', null);
INSERT INTO `bank` VALUES ('3', 'HSBC', 'Uttara', 'Sector:11, Uttara', '123456789', null);
INSERT INTO `bank` VALUES ('4', 'DBBL', 'Mymensingh', 'Mymensingh', '1991111', null);
INSERT INTO `bank` VALUES ('5', 'DBBL', 'Mymensingh', 'Mymensingh', '19911222', '4');
...
INSERT INTO `blood_donation` VALUES ('4', '5', '4', '2016-11-04', '2', '1');
...
-- ----------------------------
INSERT INTO `department` VALUES ('1', 'Medicine', null, '#c47272', '1');
INSERT INTO `department` VALUES ('2', 'Gynacology', null, '#786666', '1');
INSERT INTO `department` VALUES ('3', 'Accident and Emergency', null, '#da8585', '1');
INSERT INTO `department` VALUES ('4', 'Surgery', null, '#8a2222', '1');
INSERT INTO `department` VALUES ('6', 'Emergency', null, null, null);
INSERT INTO `department` VALUES ('7', 'Medicine', null, null, '4');
...
INSERT INTO `discharge` VALUES ('34', '13', '28', '11/6/2016', '2', 'Test', 'Test', '20', '7');
...
INSERT INTO `discharge_medicine_mapping` VALUES ('13', '34', '2', '2 mg', '1+1+1', '1 Week', null, 'After Meal');
INSERT INTO `discharge_medicine_mapping` VALUES ('14', '34', '2', '240 mg', '1+1+1', '2 Week', null, 'Before Meal');
...
-- Records of disease
-- ----------------------------
INSERT INTO `disease` VALUES ('3', 'Test22', 'tese', '2');
INSERT INTO `disease` VALUES ('4', 'Pregnent', 'Test', '2');
INSERT INTO `disease` VALUES ('5', 'Fever', 'Test', '1');
...
INSERT INTO `doctor` VALUES ('7', '1', '500', '10', '12:30 AM', '12:00 PM', 'yes', '13', '123456');
INSERT INTO `doctor` VALUES ('8', '7', '5000', '3', '11:00 AM', '1:00 PM', 'yes', '20', '123456');
...
-- ----------------------------
INSERT INTO `doctor_roster` VALUES ('1', 'Test', '2016-09-10 23:00:00', '2016-09-11 10:49:43', null, null, null, null, '4', '1', 'False');
...
CREATE TABLE `doctor_schedule` (
  `doctor_schdule_id` int(11) NOT NULL AUTO_INCREMENT,
  `department_id` int(11) DEFAULT NULL,
  `doctor_id` int(11) DEFAULT NULL,
  `shif_type_id` int(11) DEFAULT NULL,
  `sat` varchar(255) DEFAULT NULL,
  `sun` varchar(255) DEFAULT NULL,
  `mon` varchar(255) DEFAULT NULL,
  `tues` varchar(255) DEFAULT NULL,
  `wed` varchar(255) DEFAULT NULL,
  `thurs` varchar(255) DEFAULT NULL,
  `fri` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`doctor_schdule_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of doctor_schedule
-- ----------------------------
INSERT INTO `doctor_schedule` VALUES ('1', null, null, '1', 'no', 'no', 'no', 'no', 'no', 'no', 'no');
INSERT INTO `doctor_schedule` VALUES ('2', null, null, '2', 'no', 'no', 'no', 'no', 'no', 'no', 'no');
INSERT INTO `doctor_schedule` VALUES ('3', null, null, '3', 'no', 'no', 'no', 'no', 'no', 'no', 'no');
INSERT INTO `doctor_schedule` VALUES ('4', '1', '2', '1', 'Yes', 'no', 'no', 'no', 'no', 'no', 'no');
INSERT INTO `doctor_schedule` VALUES ('5', '1', '2', '2', 'no', 'Yes', 'no', 'no', 'no', 'no', 'no');
INSERT INTO `doctor_schedule` VALUES ('6', '1', '2', '3', 'no', 'no', 'no', 'no', 'no', 'no', 'no');
INSERT INTO `doctor_schedule` VALUES ('7', null, null, '4', 'no', 'no', 'no', 'no', 'no', 'no', 'no');
INSERT INTO `doctor_schedule` VALUES ('8', '7', '8', '4', 'Yes', 'no', 'Yes', 'no', 'no', 'no', 'no');
...
INSERT INTO `employee` VALUES ('12', 'Saquib', '9/9/2016', 'Receptionist', '1', '5', null, 'hms10011/2016', 'staff', '123456', 'saquib@gmail.com', 'Dhanmondi', '10011', '1', 'waiting');
INSERT INTO `employee` VALUES ('13', 'Rakhi', '11/4/2016', 'Professor', '1', '3', null, 'hms10012/2016', 'rakhi', '123456', 'rakhi@gmail.com', 'Mymensingh', '10012', '1', 'assigned');
INSERT INTO `employee` VALUES ('14', 'Test', '11/3/2016', 'Receptionist', '2', '5', '123456789', 'hms10013/2016', 'testusername', '123456', 'Test123@gmail.com', 'Moghbazar', '10013', '1', 'waiting');
INSERT INTO `employee` VALUES ('15', 'Shariya Mohammed Jobayed', null, null, null, null, null, null, 'saqure', '123456', 'jobayed@gmail.com', null, null, null, null);
INSERT INTO `employee` VALUES ('16', 'Shariaya Muhammad Jobayed', null, null, null, '8', null, null, 'saqureadmin', '123456', 'shariya@gmail.com', null, null, '6', null);
INSERT INTO `employee` VALUES ('17', 'Borsho', null, null, null, '9', null, null, 'greenlifeadmin', '123456', 'borsho@gmail.com', null, null, '7', null);
INSERT INTO `employee` VALUES ('18', 'Shariya mohammed jobayed', null, null, null, '1', null, null, 'saqureadmin', '123456', 'jobayed@gmail.com', null, null, '4', null);
INSERT INTO `employee` VALUES ('19', 'Test66', '11/4/2016', 'Accounts', '7', '3', null, 'hms10014/2016', null, null, 'Tes66t@gmail.com', 'yrte', '10014', '4', 'waiting');
INSERT INTO `employee` VALUES ('20', 'doctortest', '11/4/2016', 'Professor', '7', '3', null, 'hms10015/2016', 'saquredoctor', '123456', 'ddd@gmail.com', 'yyyy', '10015', '4', 'assigned');
INSERT INTO `employee` VALUES ('21', 'Test', null, null, null, '1', null, null, 'tt', '123456', 'tt@gmail.com', null, null, '5', null);
INSERT INTO `employee` VALUES ('22', 'Tses', '11/4/2016', 'Accounts', '7', '5', null, 'hms10016/2016', 'saqurestaff', '123456', 'te@gmail.com', 'Dhaka', '10016', '4', 'waiting');
...
-- Records of floor
-- ----------------------------
INSERT INTO `floor` VALUES ('1', 'First Floor', '20', null);
INSERT INTO `floor` VALUES ('2', 'Second Floor', '30', null);
INSERT INTO `floor` VALUES ('3', 'Third Floor', '10', null);
INSERT INTO `floor` VALUES ('4', 'First Floor', '20', '4');
...
-- ----------------------------
INSERT INTO `meta_info` VALUES ('1', '1', 'JMJKollan Hospital', 'Gouripur', '3', '3', '01611011222', 'test34', 'jmjsaquib@gmail.com', 'test', '/Images/Uploads/Logo/index.png', null);
INSERT INTO `meta_info` VALUES ('2', '2', 'test', 'fsfds', '3', '3', 'sdfsd', 'sfd', 'sfsd', 'sfsd', '/Images/Uploads/Logo/java-logo-png-300x300.png', null);
INSERT INTO `meta_info` VALUES ('3', '3', 'gsdfg', 'fgsdfg', '2', '4', 'gsdfg', 'sgdfg', 'gsdfg', 'dfsg', '/Images/Uploads/Logo/java-logo-png-300x300.png', null);
INSERT INTO `meta_info` VALUES ('8', '4', 'Saqure Hospital', 'Panthopath', '2', '4', '01611011222', 'test', 'saqure@gmail.com', 'www.saaqure.com', '/Images/Uploads/Logo/Square-Hospital-Ltd-Logo.jpg', '2016-11-03');
INSERT INTO `meta_info` VALUES ('9', '5', 'Tedt', 'Teset', '2', '4', '12345678900', 'sgrd', 'tt@gmail.com', 'www.tt.com', '/Images/Uploads/Logo/Green-Life-Medical-College-Hospital-Logo.jpg', '2016-11-04');
...
INSERT INTO `module` VALUES ('6', 'Diease List', '5', 'Disease/index', '5', 'addnewdiease', 'glyphicon glyphicon-hand-right');
INSERT INTO `module` VALUES ('7', 'Employee Registration', '3', '\'\'', '0', 'userregistration', 'glyphicon glyphicon-plus');
...
INSERT INTO `module` VALUES ('26', 'Appointment', '5', 'appoinment/index', '22', 'appoinment', 'glyphicon glyphicon-hand-right');
...
INSERT INTO `module` VALUES ('31', 'Presscription Management', '8', '\'\'', '0', 'presscription', ' 	glyphicon glyphicon-list-alt');
...
INSERT INTO `module` VALUES ('37', 'Admission Management', '9', '\'\'', '0', 'admission', ' 	glyphicon glyphicon-font');
...
INSERT INTO `module` VALUES ('43', 'Bill Management', '10', '\'\'', '0', 'bill', ' 	glyphicon glyphicon-gbp');
...
INSERT INTO `module` VALUES ('46', 'Doctor Schedule', '3', 'doctor/DoctorRoster', '27', 'doctorSchedule', 'glyphicon glyphicon-hand-right');
INSERT INTO `module` VALUES ('47', 'Blood Donation', '12', '\'\'', '0', 'blood', 'glyphicon glyphicon-heart-empty');
...
INSERT INTO `module` VALUES ('52', 'Personal Roster', '3', 'doctor/DoctorPerosnalRoster', '0', 'doctorRoaser', 'glyphicon glyphicon-book');
INSERT INTO `module` VALUES ('53', 'Dashboard', '1', 'dashboard/StaffDashBoard', '0', 'staffDashboard', 'icon-projector-screen-line');
INSERT INTO `module` VALUES ('54', 'Report', '13', '\'\'', '0', 'report', 'glyphicon glyphicon-th-list');
INSERT INTO `module` VALUES ('55', 'Patient Report', '1', 'reporting/Patient', '54', 'patientreport', 'glyphicon glyphicon-hand-right');
INSERT INTO `module` VALUES ('56', 'Patient Tracking Report', '2', 'reporting/AdmittedPatient', '54', 'pat', 'glyphicon glyphicon-hand-right');
INSERT INTO `module` VALUES ('57', 'Transaction Report', '3', 'reporting/transaction', '54', 'transaction', 'glyphicon glyphicon-hand-right');
INSERT INTO `module` VALUES ('58', 'Doctor Report', '4', 'reporting/doctor', '54', 'doctor', 'glyphicon glyphicon-hand-right');
INSERT INTO `module` VALUES ('59', 'Daily Transaction Report', '5', 'StaffReport/index', '54', 'staffReport', 'glyphicon glyphicon-hand-right');
INSERT INTO `module` VALUES ('60', 'Upcoming Appoinment', '2', 'doctor/UpcomingAppoinment', '0', 'doctorAppoinment', 'glyphicon glyphicon-list-alt');
INSERT INTO `module` VALUES ('61', 'Shift Type Entry', '11', 'doctor/ShiftType', '15', 'shifttype', 'glyphicon glyphicon-hand-right');
INSERT INTO `module` VALUES ('62', 'Department Roaster', '4', 'department/DepartmentRoster', '27', 'departmentRoaster', 'glyphicon glyphicon-hand-right');
INSERT INTO `module` VALUES ('63', 'Dashboard', '1', 'SuperAdmin/SuperADminDashboard', '0', 'superadmindashboard', 'icon-projector-screen-line');
INSERT INTO `module` VALUES ('64', 'Hospital List', '2', 'SuperAdmin/Index', '0', 'hospitallist', 'glyphicon glyphicon-home');
INSERT INTO `module` VALUES ('65', 'Add New Hospital', '3', 'SuperAdmin/AddNewHospital', '0', 'addnewhospital', 'glyphicon glyphicon-plus');
INSERT INTO `module` VALUES ('66', 'Department Roaster (Doctor)', '4', 'department/DepartmentRosterForDoctor', '0', 'departmentroaster', 'glyphicon glyphicon-book');
INSERT INTO `module` VALUES ('67', 'Doctor Roaster (Staff)', '5', 'doctor/DoctorRosterForStaff', '27', 'doctorroasterstaff', 'glyphicon glyphicon-hand-right');
...
-- Records of patient
-- ----------------------------
INSERT INTO `patient` VALUES ('1', 'jmj', '123456', 'Jakaria Muhammed Jakir', 'jmjsaquib@gmail.com', null, '2', '4', null, null, null, '1', 'male', '8/18/2016', 'admitted', '1');
INSERT INTO `patient` VALUES ('2', null, null, 'JMJ', 'jmjsaquib@gmail.com', 'sdfd', '3', '3', '2270', '01611011222', '123456', null, 'male', '12/17/1991', 'appoinmented', '1');
INSERT INTO `patient` VALUES ('3', null, null, 'Jobayed', 'shariya@gmail.com', 'Moghbazar', '2', '4', '90/80', '01979808808', '123456789', null, 'male', '6/21/1989', 'admitted', '1');
INSERT INTO `patient` VALUES ('4', null, null, 'Tom', 'hh', 'USA', '2', '4', '110/20', '123', '123', '1', 'male', '8/12/2016', 'Death', '1');
INSERT INTO `patient` VALUES ('5', null, null, 'Rezwan', 'rez@gmail.com', 'Dhanmondi', '2', '4', null, '123', null, '1', 'male', '8/1/2016', 'entry', '1');
INSERT INTO `patient` VALUES ('6', null, null, 'Chekck', 'fg@gmail.com', 'Dhanmondi', '2', '4', '110/180', '123', '123456', '1', 'male', '8/18/2016', 'admitted', '1');
INSERT INTO `patient` VALUES ('7', null, null, 'Test', 'test@gmail.com', 'tese', '2', '4', '111', '123', '123445', '1', 'male', '8/29/2016', 'admitted', '1');
INSERT INTO `patient` VALUES ('8', null, null, 'tesf', 'fs@gmail.com', 'fsdsdf', '2', '4', null, '12345678901', null, '1', 'male', '9/3/2016', 'admitted', '1');
INSERT INTO `patient` VALUES ('9', null, null, 'Test For all', 'gg@gmail.com', 'essd', '2', '4', '120', '01234567890', null, '1', 'male', '11/6/1993', 'presscribed', '1');
INSERT INTO `patient` VALUES ('10', null, null, 'Ronnie', 'ronni@gmil.com', 'Ponchogor', '3', '3', '2270', '01611011222', '123456789', '1', 'male', '10/13/1989', 'appoinmented', '1');
INSERT INTO `patient` VALUES ('11', null, null, 'Oshan', 'oshan@gmail.com', 'Mymensingh', '3', '3', '2270', '01915487718', '123456789', '1', 'male', '6/5/1991', 'admitted', '1');
INSERT INTO `patient` VALUES ('12', null, null, 'Shisho', 'shisho@gmail.com', 'Dhanmondi', '2', '4', null, '12112112112', null, '1', 'male', '9/6/2016', 'presscribed', '1');
INSERT INTO `patient` VALUES ('13', null, null, 'Patientteste', 'teste@gmail.com', 'tere', '2', '4', null, '01611011122', null, '1', 'male', '11/1/2016', 'entry', null);
...
INSERT INTO `patient_emergency_contact` VALUES ('12', 'tgrt', 'Father', '01915487715', '13');
...
INSERT INTO `patient_health_info` VALUES ('12', '13', 'O+', null, '0', null, null);
...
-- Records of payment
-- ----------------------------
INSERT INTO `payment` VALUES ('1', null, '7', null, '15', '1', '2016-09-02', '1000', '0', '5', '950', '2', null);
INSERT INTO `payment` VALUES ('2', null, '7', null, '16', '1', '2016-09-02', '2000', '0', '50', '1000', '3', null);
INSERT INTO `payment` VALUES ('3', null, '7', null, '17', '1', '2016-09-02', '2000', '0', '50', '1000', '2', null);
INSERT INTO `payment` VALUES ('4', null, '7', '20', '18', '1', '2016-09-01', '2000', '0', '5', '1900', '2', null);
INSERT INTO `payment` VALUES ('5', null, '7', '20', '19', '2', '2016-09-04', '1000', '0', '5', '950', '1', null);
INSERT INTO `payment` VALUES ('6', null, '6', '13', '20', '1', '2016-09-04', '5500', '0', '500', '5000', '2', null);
INSERT INTO `payment` VALUES ('7', null, '7', '20', '21', '1', '2016-09-04', '2000', '0', '500', '1500', '2', null);
INSERT INTO `payment` VALUES ('8', null, '4', '6', '22', '1', '2016-09-04', '4200', '0', '5', '3990', '2', null);
INSERT INTO `payment` VALUES ('9', null, '4', '7', '23', '1', '2016-09-04', '2000', '0', '5', '1900', '2', null);
INSERT INTO `payment` VALUES ('10', null, '4', '5', '24', '1', '2016-09-10', '6000', '0', '500', '5500', '2', null);
INSERT INTO `payment` VALUES ('11', null, '7', '20', '25', '1', '2016-09-10', '1000', '0', '5', '950', '2', null);
INSERT INTO `payment` VALUES ('12', null, '7', '20', '26', '2', '2016-09-10', '1000', '0', '5', '950', '2', null);
INSERT INTO `payment` VALUES ('13', null, '10', '21', '27', '1', '2016-09-10', '500', '0', '5', '475', '2', null);
INSERT INTO `payment` VALUES ('14', null, '11', '22', '28', '1', '2016-09-05', '30000', '0', '500', '29500', '2', null);
INSERT INTO `payment` VALUES ('15', null, '12', '24', '29', '1', '2016-09-06', '10000', 'Percentage', '5', '9500', '2', null);
INSERT INTO `payment` VALUES ('16', null, '3', '23', '30', '1', '2016-09-07', '0', 'Percentage', '20', '30', '2', null);
INSERT INTO `payment` VALUES ('17', null, '8', '25', '31', '1', '2016-09-07', '10000', 'Amount', '5', '9500', '2', null);
INSERT INTO `payment` VALUES ('19', null, '6', '26', '32', '1', '2016-09-10', '900', 'Percentage', '2', '882', '3', null);
INSERT INTO `payment` VALUES ('20', null, '1', '27', '33', '1', '2016-09-10', '2400', 'Percentage', '6', '2256', '3', null);
INSERT INTO `payment` VALUES ('21', null, '13', '28', '34', '2', '2016-11-04', '15300', 'Amount', '300', '15000', '3', '4');
...
INSERT INTO `payment_cheque_details` VALUES ('20', '5', '3232423', '323432', '2016-11-07', '21');
...
CREATE TABLE `presscription` (
  ...
  `presscription_date` date DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `presscription` VALUES ('11', '2', '4', '2016-11-03', 'no', null);
INSERT INTO `presscription` VALUES ('12', '4', '5', '2016-11-04', 'yes', null);
INSERT INTO `presscription` VALUES ('13', '6', '7', '2016-11-04', 'yes', null);
INSERT INTO `presscription` VALUES ('14', '5', '6', '2016-11-04', 'yes', null);
INSERT INTO `presscription` VALUES ('15', '5', '6', '2016-11-04', 'yes', null);
INSERT INTO `presscription` VALUES ('16', '5', '6', '2016-11-04', 'yes', null);
INSERT INTO `presscription` VALUES ('17', '1', '8', '2016-11-04', 'yes', null);
INSERT INTO `presscription` VALUES ('18', '7', '9', '2016-11-04', 'yes', null);
INSERT INTO `presscription` VALUES ('19', '7', '9', '2016-11-04', 'yes', null);
INSERT INTO `presscription` VALUES ('20', '3', '1', '2016-11-04', 'yes', null);
INSERT INTO `presscription` VALUES ('21', '3', '1', '2016-11-04', 'yes', null);
INSERT INTO `presscription` VALUES ('22', '6', '7', '2016-11-04', 'yes', null);
INSERT INTO `presscription` VALUES ('23', '9', '11', '2016-11-04', 'no', null);
INSERT INTO `presscription` VALUES ('24', '10', '37', '2016-11-04', 'yes', null);
INSERT INTO `presscription` VALUES ('25', '11', '38', '2016-11-04', 'yes', null);
INSERT INTO `presscription` VALUES ('26', '12', '39', '2016-11-04', 'yes', null);
INSERT INTO `presscription` VALUES ('27', '12', '39', '2016-11-04', 'yes', null);
INSERT INTO `presscription` VALUES ('28', '8', '14', '2016-11-04', 'yes', null);
INSERT INTO `presscription` VALUES ('29', '6', '10', '2016-11-04', 'yes', null);
INSERT INTO `presscription` VALUES ('30', '12', '40', '2016-11-04', 'yes', null);
INSERT INTO `presscription` VALUES ('31', '13', '42', '2016-11-04', 'yes', null);
...
INSERT INTO `presscription_complaints_mapping` VALUES ('14', '30', 'Headache', '1 Week');
INSERT INTO `presscription_complaints_mapping` VALUES ('15', '31', 'Pain', '1 Week');
INSERT INTO `presscription_complaints_mapping` VALUES ('16', '31', 'Headache', '1 Week');
...
INSERT INTO `presscription_drug_allergies_mapping` VALUES ('49', '30', 'none');
INSERT INTO `presscription_drug_allergies_mapping` VALUES ('50', '31', 'Sulfa');
INSERT INTO `presscription_drug_allergies_mapping` VALUES ('51', '31', 'Anticonvulsants');
...
INSERT INTO `presscription_health_condition_mapping` VALUES ('32', '30', 'none');
INSERT INTO `presscription_health_condition_mapping` VALUES ('33', '31', 'Kidney Problem');
...
INSERT INTO `presscription_medicine_mapping` VALUES ('22', '30', '2', '2 mg', '1+1+0', '3 Week', null, 'Before Meal');
INSERT INTO `presscription_medicine_mapping` VALUES ('23', '31', '2', '2 mg', '1+1+0', '1 Week', 'oral', 'Before Meal');
...
INSERT INTO `presscription_suggestion_mapping` VALUES ('46', '30', 'Walking');
INSERT INTO `presscription_suggestion_mapping` VALUES ('47', '30', 'Take Rest');
INSERT INTO `presscription_suggestion_mapping` VALUES ('48', '31', 'Take Rest');
...
INSERT INTO `presscription_test_type_mapping` VALUES ('31', '30', '1');
INSERT INTO `presscription_test_type_mapping` VALUES ('32', '31', '1');
INSERT INTO `presscription_test_type_mapping` VALUES ('33', '31', '4');
...
INSERT INTO `role_permission` VALUES ('54', '5', '5');
INSERT INTO `role_permission` VALUES ('55', '5', '6');
INSERT INTO `role_permission` VALUES ('56', '5', '22');
INSERT INTO `role_permission` VALUES ('57', '5', '23');
INSERT INTO `role_permission` VALUES ('58', '5', '24');
INSERT INTO `role_permission` VALUES ('59', '5', '26');
INSERT INTO `role_permission` VALUES ('60', '5', '31');
INSERT INTO `role_permission` VALUES ('61', '5', '32');
INSERT INTO `role_permission` VALUES ('62', '5', '33');
INSERT INTO `role_permission` VALUES ('63', '5', '37');
INSERT INTO `role_permission` VALUES ('64', '5', '38');
INSERT INTO `role_permission` VALUES ('65', '5', '39');
INSERT INTO `role_permission` VALUES ('66', '5', '40');
INSERT INTO `role_permission` VALUES ('67', '5', '43');
INSERT INTO `role_permission` VALUES ('68', '5', '44');
INSERT INTO `role_permission` VALUES ('69', '5', '47');
INSERT INTO `role_permission` VALUES ('70', '5', '48');
INSERT INTO `role_permission` VALUES ('71', '5', '49');
INSERT INTO `role_permission` VALUES ('72', '5', '50');
INSERT INTO `role_permission` VALUES ('73', '5', '53');
INSERT INTO `role_permission` VALUES ('74', '1', '55');
INSERT INTO `role_permission` VALUES ('75', '1', '56');
INSERT INTO `role_permission` VALUES ('76', '1', '57');
INSERT INTO `role_permission` VALUES ('77', '1', '58');
INSERT INTO `role_permission` VALUES ('78', '1', '54');
INSERT INTO `role_permission` VALUES ('79', '1', '59');
INSERT INTO `role_permission` VALUES ('80', '5', '59');
INSERT INTO `role_permission` VALUES ('81', '5', '54');
INSERT INTO `role_permission` VALUES ('82', '3', '54');
INSERT INTO `role_permission` VALUES ('83', '3', '60');
INSERT INTO `role_permission` VALUES ('84', '1', '61');
INSERT INTO `role_permission` VALUES ('85', '1', '62');
INSERT INTO `role_permission` VALUES ('86', '5', '62');
INSERT INTO `role_permission` VALUES ('87', '7', '63');
INSERT INTO `role_permission` VALUES ('88', '7', '64');
INSERT INTO `role_permission` VALUES ('89', '7', '65');
INSERT INTO `role_permission` VALUES ('90', '10', '1');
INSERT INTO `role_permission` VALUES ('91', '10', '4');
INSERT INTO `role_permission` VALUES ('92', '10', '5');
INSERT INTO `role_permission` VALUES ('93', '10', '6');
INSERT INTO `role_permission` VALUES ('94', '10', '7');
INSERT INTO `role_permission` VALUES ('95', '10', '8');
INSERT INTO `role_permission` VALUES ('96', '10', '9');
INSERT INTO `role_permission` VALUES ('97', '10', '16');
INSERT INTO `role_permission` VALUES ('98', '10', '17');
INSERT INTO `role_permission` VALUES ('99', '10', '10');
INSERT INTO `role_permission` VALUES ('100', '10', '11');
INSERT INTO `role_permission` VALUES ('101', '10', '12');
INSERT INTO `role_permission` VALUES ('102', '10', '13');
INSERT INTO `role_permission` VALUES ('103', '10', '14');
INSERT INTO `role_permission` VALUES ('104', '10', '15');
INSERT INTO `role_permission` VALUES ('105', '10', '18');
INSERT INTO `role_permission` VALUES ('106', '10', '19');
INSERT INTO `role_permission` VALUES ('107', '10', '20');
INSERT INTO `role_permission` VALUES ('108', '10', '21');
INSERT INTO `role_permission` VALUES ('109', '10', '22');
INSERT INTO `role_permission` VALUES ('110', '10', '23');
INSERT INTO `role_permission` VALUES ('111', '10', '24');
INSERT INTO `role_permission` VALUES ('112', '10', '26');
INSERT INTO `role_permission` VALUES ('113', '10', '27');
INSERT INTO `role_permission` VALUES ('114', '10', '28');
INSERT INTO `role_permission` VALUES ('115', '10', '29');
INSERT INTO `role_permission` VALUES ('116', '10', '31');
INSERT INTO `role_permission` VALUES ('117', '10', '32');
INSERT INTO `role_permission` VALUES ('118', '10', '33');
INSERT INTO `role_permission` VALUES ('119', '10', '34');
INSERT INTO `role_permission` VALUES ('120', '10', '36');
INSERT INTO `role_permission` VALUES ('121', '10', '37');
INSERT INTO `role_permission` VALUES ('122', '10', '38');
INSERT INTO `role_permission` VALUES ('123', '10', '39');
INSERT INTO `role_permission` VALUES ('124', '10', '40');
INSERT INTO `role_permission` VALUES ('125', '10', '41');
INSERT INTO `role_permission` VALUES ('126', '10', '42');
INSERT INTO `role_permission` VALUES ('127', '10', '43');
INSERT INTO `role_permission` VALUES ('128', '10', '44');
INSERT INTO `role_permission` VALUES ('129', '10', '45');
INSERT INTO `role_permission` VALUES ('130', '10', '46');
INSERT INTO `role_permission` VALUES ('131', '10', '47');
INSERT INTO `role_permission` VALUES ('132', '10', '48');
INSERT INTO `role_permission` VALUES ('133', '10', '49');
INSERT INTO `role_permission` VALUES ('134', '10', '50');
INSERT INTO `role_permission` VALUES ('135', '10', '55');
INSERT INTO `role_permission` VALUES ('136', '10', '56');
INSERT INTO `role_permission` VALUES ('137', '10', '57');
INSERT INTO `role_permission` VALUES ('138', '10', '58');
INSERT INTO `role_permission` VALUES ('139', '10', '54');
INSERT INTO `role_permission` VALUES ('140', '10', '59');
INSERT INTO `role_permission` VALUES ('141', '10', '61');
INSERT INTO `role_permission` VALUES ('142', '10', '62');
INSERT INTO `role_permission` VALUES ('143', '3', '66');
INSERT INTO `role_permission` VALUES ('144', '5', '27');
INSERT INTO `role_permission` VALUES ('145', '5', '62');
INSERT INTO `role_permission` VALUES ('146', '5', '67');
...
-- ----------------------------
INSERT INTO `role_type` VALUES ('1', 'admin', 'this is admin role.', null);
INSERT INTO `role_type` VALUES ('2', 'patient', 'this is patient role.', null);
INSERT INTO `role_type` VALUES ('3', 'doctor', 'this is doctor role.', null);
INSERT INTO `role_type` VALUES ('5', 'Staff', 'this is staff role.', null);
INSERT INTO `role_type` VALUES ('6', 'Nurse', 'This is nurse role.', null);
INSERT INTO `role_type` VALUES ('7', 'Super Admin', 'This is super admin', null);
...
-- Records of room
-- ----------------------------
INSERT INTO `room` VALUES ('1', 'cabin101', 'No ac', '1', '1', '2', 'Waiting', '1', '-2', '4', null);
INSERT INTO `room` VALUES ('2', 'cabin102', 'ac', '2', '2', '3', 'full', '1', '3', '0', null);
INSERT INTO `room` VALUES ('3', 'cabin103', 'ac best', '3', '2', '2', 'Waiting', '2', '1', '1', null);
INSERT INTO `room` VALUES ('4', 'Cabin 101', 'dfd', '1', '1', '2', 'full', '2', '2', '0', null);
INSERT INTO `room` VALUES ('5', 'Surgery Cabin', 'fd', '2', '3', '2', 'Waiting', '4', '1', '1', null);
INSERT INTO `room` VALUES ('6', 'Med101Cab', 'Test', '5', '4', '2', 'Waiting', '7', '-1', '3', '4');
...
-- ----------------------------
INSERT INTO `room_type` VALUES ('1', 'General', '500', 'Non AC, General ward', null);
INSERT INTO `room_type` VALUES ('2', 'VIP', '5000', 'Only for VIP patient.', null);
INSERT INTO `room_type` VALUES ('3', 'AC', '2000', 'AC room. For all.', null);
INSERT INTO `room_type` VALUES ('4', 'General', '1000', 'Saqure Genral', null);
INSERT INTO `room_type` VALUES ('5', 'SaqrureGenral', '100', 'Fff', '4');
...
-- ----------------------------
INSERT INTO `shift_type` VALUES ('1', 'Morning', '7:00 AM', '3:00 PM', null);
INSERT INTO `shift_type` VALUES ('2', 'Evening', '3:00 PM', '11:00 PM', null);
INSERT INTO `shift_type` VALUES ('3', 'Night', '11:00 PM', '7:00 AM', null);
INSERT INTO `shift_type` VALUES ('4', 'Morning', '7:00 AM', '3:00 PM', '4');
...
CREATE TABLE `super_admin` (
  ...
  `super_user_name` varchar(255) DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `super_admin` VALUES ('1', 'Jakaria Muhammed Jakir', 'JMJ Production', 'Mymensingh', 'super', '123456');
...
-- Records of ward
-- ----------------------------
INSERT INTO `ward` VALUES ('1', 'ward101', 'ward101', '1', '50', 'general', 'male', '0', '1', 'right', '2', '48', 'waiting', null);
INSERT INTO `ward` VALUES ('2', 'ward102', 'ward102', '2', '60', 'paid', 'male', '500', '2', 'left', '0', '60', 'waiting', null);
INSERT INTO `ward` VALUES ('3', 'ward103', 'ward103', '2', '20', 'paid', 'female', '1000', '2', 'right', '-1', '21', 'waiting', null);
INSERT INTO `ward` VALUES ('4', 'Test2', 'Test', '2', '30', 'general', 'male', '0', '1', 'left', '0', '30', 'waiting', null);
INSERT INTO `ward` VALUES ('5', 'Surgery Ward', 'Surgery Ward', '4', '30', 'paid', 'male', '500', '3', 'right', '0', '30', 'waiting', null);
INSERT INTO `ward` VALUES ('8', 'Tests', 'Test', '7', '20', 'general', 'male', '20', '4', 'left', '0', '20', 'waiting', '4');
